(function () {
        ...
        '<div class="footer-inner">' +
          ...
          '<div class="footer-bottom">' +
            '<div class="footer-mid">' +
              ...
              '<div class="footer-social-line"><p class="hetle">@ajbloks</p><div class="social-row">' +
            ...
            '<div class="footer-legal-bar">' +
              ...
              '<button class="footer-chat-btn" type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/></svg>Discussion</button>' +
            '</div>' +
          '</div>' +
        '</div>' +
      '</footer>'
  ...
  function initFooterSignup() {
    ...
    footerSignupForm.addEventListener('submit', function (e) {
      ...
      var run = window.AJBNewsletter && window.AJBNewsletter.subscribe
        ? window.AJBNewsletter.subscribe({ email: email, source: 'footer' })
        : Promise.reject(new Error('unavailable'));
      Promise.resolve(run)
        .then(function () {
          footerSignupConfirmer.textContent = "Merci pour votre inscription ! Consultez votre boîte de réception pour confirmer.";
